...
public class ObjectEditor
    ...
    public ObjectEditor(final EnvObjectLogic obj) {
        ...
        DefaultComboBoxModel<Representation> representationsModel = new DefaultComboBoxModel<>();
...
//GEN-FIRST:event_txtNameActionPerformed
    ...
    private javax.swing.JComboBox<EnvironmentLogic> environmentComboBox;
    ...
    private javax.swing.JComboBox<String> txtProtocol;
    ...
    private void populateCommandsTab() {
        ...
        for (final String action : object.getPojo().getActions().stringPropertyNames()) {
            ...
            DefaultComboBoxModel<Command> allHardwareCommands = new DefaultComboBoxModel<>();

            for (Command command : api.commands().findHardwareCommands()) {
                allHardwareCommands.addElement(command);
            }

            final JComboBox<Command> cmbCommand = new JComboBox<>();
    ...
    private void populateTriggersTab() {
        ...
        for (final Behavior behavior : object.getPojo().getBehaviors()) {
            ...
            DefaultComboBoxModel<Trigger> model = new DefaultComboBoxModel<>();
            ...
            final JComboBox<Trigger> comboSelectTrigger = new JComboBox<>();
